# dsh Web 工作台 P1 页移植规格（personal-agent · vanilla JS + Go）

> 目标：参照 dsh web（deepseek-harness `packages/client/*`）把 personal-agent 的主工作台页面做到「像 dsh 一样」。
